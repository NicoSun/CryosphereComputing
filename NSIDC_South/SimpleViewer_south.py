...
class Simpleviewer:
	...
	def viewloop(self):
		...
		for count in range (0,self.daycount,1): 
			...
			filenamemax = 'DataFiles/Maximum/NSIDC_Max_'+str(self.month).zfill(2)+str(self.day).zfill(2)+'_south.bin'
			filenamemin = 'DataFiles/Minimum/NSIDC_Min_'+str(self.month).zfill(2)+str(self.day).zfill(2)+'_south.bin'
			filenamemean = 'DataFiles/Daily_Mean/NSIDC_Mean_'+str(self.month).zfill(2)+str(self.day).zfill(2)+'_south.bin'
