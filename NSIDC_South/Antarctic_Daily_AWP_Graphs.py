...
class AWP_graphs_south:
	...
	def daily_graph(self):
		...
		ax.text(0.7, -0.06, 'cryospherecomputing.tk/awp-south',transform=ax.transAxes,color='grey', fontsize=10)
...
#		plt.plot( self.C2012_daily, color='orange',label='2012',lw=1)
		...
		plt.plot( self.C20167_daily, color='red',label='2016-7',lw=1)
		plt.plot( self.CSVDaily, color='black',label='2019-20',lw=2)
		...
		fig.savefig('X:/Upload/AWP/South_AWP_Graph1.png',bbox_extra_artists=(lgd,))
		plt.close()
#		plt.show()
...
#		plt.plot( self.C2012, color='orange',label='2012',lw=1)
		...
		plt.plot( self.C20167, color='red',label='2016-7',lw=1)
		plt.plot( self.CSVCumu, color='black',label='2019-20',lw=2)
		...
		fig.savefig('X:/Upload/AWP/South_AWP_Graph2.png',bbox_extra_artists=(lgd,))
		plt.close()
#		plt.show()
	...
	def daily_anomaly(self):
		...
		anom_20189 = list(map(self.minus,self.C20189_daily,self.AWP_Daily_mean))
		...
		plt.plot( anom_20167, color='red',label='2016-7',lw=1)
		plt.plot( anom_20189, color='brown',label='2018-9',lw=1)
		plt.plot( current_anom, color='black',label='2019-20',lw=2)
		...
		fig.tight_layout(pad=1)
		fig.subplots_adjust(top=0.95)
		fig.savefig('X:/Upload/AWP/South_AWP_Graph3.png',bbox_extra_artists=(lgd,))
		plt.close()
	...
	def accumu_anomaly(self):
		...
		anom_20189 = list(map(self.minus,self.C20189,self.AWP_Accu_mean))
		...
		fig.tight_layout(pad=1)
		fig.subplots_adjust(top=0.95)
		fig.savefig('X:/Upload/AWP/South_AWP_Graph4.png',bbox_extra_artists=(lgd,))
		plt.close()
			
	def regiongraph(self):
		
		Climatecolnames = ['Date','B','C','D','E','F']
		Climatedata = pandas.read_csv('X:/Upload/AWP_data/Climatology/South_AWP_mean_regional.csv', names=Climatecolnames,header=0)
		...
		fig.savefig('X:/Upload/AWP/South_AWP_Graph_Region1.png')
		plt.close()
	...
	def regiongraph_daily(self):
		...
		Climatecolnames = ['Date','B','C','D','E','F']
		Climatedata = pandas.read_csv('X:/Upload/AWP_data/Climatology/South_AWP_mean_regional_daily.csv', names=Climatecolnames,header=0)
		Wed_mean = Climatedata.B.tolist()
		Ind_mean = Climatedata.C.tolist()
		Pac_mean = Climatedata.D.tolist()
		Ross_mean = Climatedata.E.tolist()
		...
		fig.tight_layout(pad=1)
		fig.subplots_adjust(top=0.95)
		fig.savefig('X:/Upload/AWP/South_AWP_Graph_Region2.png')
		plt.close()

	
	def loadCSVdata (self):
		Yearcolnames = ['Date','B','C']
		Yeardata = pandas.read_csv('X:/Upload/AWP_data/South_AWP_NRT.csv', names=Yearcolnames,header=0)
		...
		AWP_mean = ['A','B','C']
		Climatedata = pandas.read_csv('X:/Upload/AWP_data/Climatology/South_AWP_mean.csv', names=AWP_mean,header=0)
		self.AWP_Daily_mean = Climatedata.B.tolist()
		self.AWP_Accu_mean = Climatedata.C.tolist()
		
		
		AWP_daily = ['A', 'B', 'C', 'D', 'E', 'F', 'G', 'H', 'I', 'J']
		Climatedata = pandas.read_csv('X:/Upload/AWP_data/Climatology/South_AWP_pan_Daily.csv', names=AWP_daily,header=0)
#		Date = Climatedata.A.tolist()
		...
		self.C20189_daily = Climatedata.J.tolist()
		
		AWP_accu = ['A', 'B', 'C', 'D', 'E', 'F', 'G', 'H', 'I', 'J']
		Climatedata = pandas.read_csv('X:/Upload/AWP_data/Climatology/South_AWP_pan_Accumulated.csv', names=AWP_accu,header=0)
#		Date = Climatedata.A.tolist()
		...
		self.C20189 = Climatedata.J.tolist()
	
	
	def loadCSVRegiondata (self):
		Yearcolnames = ['A', 'B', 'C', 'D', 'E', 'F']
		Yeardata = pandas.read_csv('X:/Upload/AWP_data/South_AWP_NRT_regional.csv', names=Yearcolnames,header=0)
		...
		Yeardata = pandas.read_csv('X:/Upload/AWP_data/South_AWP_NRT_regional_daily.csv', names=Yearcolnames_daily,header=0)
