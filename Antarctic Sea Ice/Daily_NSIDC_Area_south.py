...
#			filenameMin = 'Min/NSIDC_Min_{}{}.bin'.format(self.stringmonth,self.stringday)
	...
	def normalshow(self,icemap,icesum):
		...
		self.ax.text(-0.04, 0.78, 'https://sites.google.com/site/cryospherecomputing/daily-data-antarctic',
	...
	def anomalyshow(self,icemap,icesum):
		...
		self.ax2.text(-0.04, 0.78, 'https://sites.google.com/site/cryospherecomputing/daily-data-antarctic',
...
if __name__ == "__main__":
	...
	#action.loadCSVdata()
	#action.dayloop()
	action.automated(17,11,2018,1) #note substract xxx days from last available day
	#action.makegraph()
