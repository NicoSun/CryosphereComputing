...
#	snowmap = np.ma.masked_greater(snowmap, 366)
	...
	ax.set_title('NOAA / NSIDC IMS Snow & Ice covered days anomaly  Year {} (no Jan)'.format(year),x=0.5)
	ax.set_xlabel('Data source: https://nsidc.org/data/g02156',x=0.22)
	ax.set_ylabel('https://sites.google.com/site/cryospherecomputing/snow-cover',y=0.25)
...
#				break
		...
		with open('netcdf/anomaly/Snow_cover_days_anomaly_{}.bin'.format(file[16:20]), 'wb') as fwr:
