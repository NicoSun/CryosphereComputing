...
class ADS_data:
	...
	def makeVolumegraph(self):
		...
		fig.suptitle('AMSR2 Sea Ice Volume', fontsize=14, fontweight='bold')
		...
		ax.text(0.5, -0.06, 'https://sites.google.com/site/cryospherecomputing/amsr2-sea-ice-volume',
        transform=ax.transAxes,
        color='grey', fontsize=10)	
		...
		plt.plot( self.V2018, color='black',label='2018',lw=2)	
	...
	def makeThicknessgraph(self):
		...
		fig = plt.figure(figsize=(12, 8))
		fig.suptitle('AMSR2 Sea Ice Thickness', fontsize=14, fontweight='bold')
		ax = fig.add_subplot(111)
		labels = ['Jan', 'Feb', 'Mar', 'Apr','May','Jun','Jul','Aug','Sep','Oct','Nov','Dec']
		x = [0,31,60,91,121,152,182,213,244,274,305,335]
		plt.xticks(x,labels)
		...
		plt.plot( self.T2018, color='black',label='2018',lw=2)	
	...
	def loadCSVdata (self):
		...
		#Volume Data
		Volumecolnames = ['Date','C2012', 'C2013', 'C2014', 'C2015', 'C2016', 'C2017', 'C2018']
		...
		self.V2018 = Volumedata.C2018.dropna().tolist()
		
		#Thickness Data
		Thicknesscolnames = ['Date','C2012', 'C2013', 'C2014', 'C2015', 'C2016', 'C2017', 'C2018']
