...
class degreefreezing:
	...
	def loaddata(self):
		...
		Climatecolnames = ['A', 'B', 'C', 'D', 'E', 'F','G','H','I','J','K','L']
...
#		plt.plot( self.C2015, color='yellow',label='2015/6',lw=2)
	...
	def makeanomgraph(self):
		...
		C2018_anom = list(map(self.minus,self.currentjahr,self.ERA40))
		...
		lastFDD_anom = round(float(C2018_anom[-1]))
		averageTemp_anom = round(lastFDD_anom/len(C2018_anom),2)
