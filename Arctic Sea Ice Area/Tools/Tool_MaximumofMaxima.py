...
def looop():
	...
	for count in range (0,daycount,1): #366
		filenamemax = 'test/NSIDC_Max_'+str(month).zfill(2)+str(day).zfill(2)+'.bin'
		...
		for x in range (0,136192):
			icedavf[x] = max(ice7f[x],ice8f[x],ice9f[x],ice10f[x],ice11f[x],ice12f[x],ice13f[x],ice14f[x],ice15f[x],ice16f[x],ice17f[x])
